...
func (c *AttributeModifierDisplay) ReadFrom(r io.Reader) (n int64, err error) {
	var temp int64
	...
	if c.Type == 2 {
		temp, err = (&c.OverrideText).ReadFrom(r)
		n += temp
		if err != nil {
			return n, err
		}
...
func (c AttributeModifierDisplay) WriteTo(w io.Writer) (n int64, err error) {
	var temp int64
	...
	if c.Type == 2 {
		temp, err = (&c.OverrideText).WriteTo(w)
		n += temp
		if err != nil {
			return n, err
		}
...
func (c *PotionContents) ReadFrom(r io.Reader) (n int64, err error) {
	...
	temp, err = (*packet.Boolean)(&c.HasCustomName).ReadFrom(r)
	n += temp
	if err != nil {
		return n, err
	}
...
func (c PotionContents) WriteTo(w io.Writer) (n int64, err error) {
	...
	temp, err = (*packet.Boolean)(&c.HasCustomName).WriteTo(w)
	n += temp
	if err != nil {
		return n, err
	}
